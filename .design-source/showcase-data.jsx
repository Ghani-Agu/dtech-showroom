// showcase-data.jsx — categories, brands, products
...
const COUNT_BY_CAT = {};
PRODUCTS.forEach(p => { COUNT_BY_CAT[p.cat] = (COUNT_BY_CAT[p.cat] || 0) + 1; });

Object.assign(window, { CATEGORIES, BRANDS, PRODUCTS, COUNT_BY_CAT });
